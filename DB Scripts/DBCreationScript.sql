...
/****** Object:  Database [BloggerDB]    Script Date: 15/9/2021 2:52:38 am ******/
...
ALTER DATABASE [BloggerDB] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [BloggerDB] SET READ_COMMITTED_SNAPSHOT ON 
GO

ALTER DATABASE [BloggerDB] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [BloggerDB] SET RECOVERY FULL 
GO
